...
const NotificationItem = () => {
  return (
    <div className="p-3 flex space-x-2 hover:bg-gray-100 rounded-lg cursor-pointer">
      <img
      ...
      <div>
        ...
        <p className="text-gray-500 text-xs">Answered to your comment on the cash flow forecasts graph 🔔.</p>
